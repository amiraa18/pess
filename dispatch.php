...
if (!isset($_POST["btnProcessCall"]) && !isset($_POST["btnDispatched"]))
...
<?php
	...
	if (isset ($_POST["btnDispatch"]))
	{
		require_once 'db.php';
			...
			$sql = "INSERT INTO incident (caller_name, phone_number, incident_type_id, 
incident_location, incident_desc, incident_status_id) VALUES('".$_POST['callerName']."','".$_POST['contactNo']."', '".$_POST['incidentType']."','".$_POST['location']."', '".$_POST['incidentDesc']."', $incidentStatus)";
